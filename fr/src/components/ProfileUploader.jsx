  ...
  return (
    <div className="flex flex-col justify-baseline items-baseline gap-2">
      ...
      <button
        type="button"
        onClick={handleClick}
        className="block bg-black text-white p-2 font-semibold text-sm rounded-lg shadow cursor-pointer hover:outline-blue-700 hover:outline-1 hover:bg-gray-800 transition"
      >
        Editar Foto
      </button>
