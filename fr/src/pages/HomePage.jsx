  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center">
        <section className="bg-[url(/src/assets/bannerHome.png)] bg-no-repeat bg-cover h-70 pb-15 w-full text-center flex justify-center items-end ">
          <h1 className="text-white text-6xl font-[Energy]">
            SICA: O mundo é dos OUSADOS!
          </h1>
        </section>

        <div className="flex flex-col gap-5 my-7.5 justify-center items-center">   
        <section className="bg-secundaria text-white flex flex-row justify-center items-center w-[80%]">
          <img src={image1} alt="Garota jogando basquete" className="w-[70%]" />
          ...
          <section className="bg-primaria text-white flex flex-row justify-center items-center w-[80%]">
            <p className="p-5 font-sans">
