    ...
    <>
      <header className="fixed z-30 w-full bg-white md:backdrop-blur md:bg-white/5 border-b border-white/20">
        <div className="flex items-center justify-between px-10 py-2">
          ...
          <button onClick={handleClick} className="z-50 flex md:hidden flex-col justify-center items-center hover:cursor-pointer">
            <span
      ...
      <aside
        className={`fixed z-40 top-15 right-0 h-full w-55 bg-white shadow-lg transform ${
