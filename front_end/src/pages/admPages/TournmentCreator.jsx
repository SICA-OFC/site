      ...
      <div className="bg-[#f5f5f5] rounded shadow-[0_0_30px_rgba(0,0,0,0.1)] px-[10%] py-[3%] max-w-[1000px] w-full flex flex-col items-center">
        ...
        <form className="w-full">
          ...
          <div className="flex justify-center gap-5 mt-8">
            ...
            <button
              type="reset"
              className="bg-[#f18e2c] text-white px-6 py-2 rounded-lg border-[#f5f5f5] hover:bg-white hover:text-[#f18e2c] border hover:border-[#f18e2c] transition cursor-pointer"
            >
              Limpar Campos
            </button>
